...
const RegisterPage = () => {
  return (
    <div className="page-enter min-h-screen flex items-center justify-center px-4 py-12">
      <div className="max-w-2xl w-full">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 stagger-children">
          {[
            ...
            <div key={item.title} className={`glass rounded-xl p-4 border ${item.border} text-center card-hover scale-in group`}>
              <i className={`fas ${item.icon} text-2xl ${item.color} mb-2 block transition-transform duration-300 group-hover:scale-125`}></i>
